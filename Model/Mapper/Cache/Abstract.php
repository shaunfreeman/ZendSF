...
/**
 * Provides a cache for mapper methods.
 * Cache proxy for mappers, proxies calls to the model to
...
abstract class ZendSF_Model_Mapper_Cache_Abstract
{
    ...
    {
        if ('Class' != $frontend) {
            throw new ZendSF_Model_Exception('Frontend type must be a Class');
        }
